...
export default (props) => {
  const dispatch = useDispatch();
   ...
   const projectName = 'Publications';
   const history = useHistory();
   const user = JSON.parse(localStorage.getItem('userdetails')).user_employee_detail[0].full_name;
 ...
 const antIcon = <LoadingOutlined spin />; 
  ...
  const saveDraft = () => {
    ...
    if(value.publication_name) {
      onFinish(value, 'Draft');
    } else {
      message.error('Please Enter Publication Name')
    }
  }
  ...
  const onFinish = async (value,stats) => {
    ...
    try {
        ...
        message.success('Publication Successfully Added');
        reset();
    ...
    return (
       ...
       <Row gutter={[20, 30]} style={{ marginBottom: "15px" }} >
         ...
         <Col span={24}>
        <Space direction='vertical' size={20}>
         <HeadingChip title="Add New Publication"/>
         </Space>
        </Col>
		 ...
		 <Card bordered={false} gutter={[20, 30]} className='uni-card'>
     ...
     <Row gutter={[20, 30]} vgutter={8}>
            ...
            <InputField 
              ...
              validMessage={errors.grant_name && errors.publication_name.message}
           ...
           <Col span={12}>
            <InputField 
              ...
              validate={errors.publication_name && 'error'}
              validMessage={errors.grant_name && errors.publication_name.message}
                iProps={{readOnly: true, placeholder: 'Please type author name', size: 'large', type: 'text'}}
           ...
           <Col span={12}>
            <InputField 
              ...
              validMessage={errors.grant_name && errors.co_author_name.message}
         ...
         <Col span={24}>
          ...
          <Col span={24}>
            <Row gutter={[20, 20]} justify="end">
              <Col flex='0 1 200px'><Button type='primary' size='large' htmlType='button' className='w-100 black-btn'  onClick={() => saveDraft()} >Save Draft</Button></Col>
              <Col flex='0 1 200px'><Button type='primary' size='large' htmlType='submit' className='w-100 green-btn'>Add Publication</Button></Col>
            </Row>
          </Col>
